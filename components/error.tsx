...
export const NotFoundAlert: React.FC<any> = () => {
...
export const ErrorBoundaryAlert: React.FC<ErrorBoundaryProps> = ({ error, retry }) => {
  const router = useRouter();
  ...
  const renderHeaderRight = () => (
    <Button action="secondary" variant="link" onPress={() => retry()}>
