...
export const config = {
  light: vars({
    ...
    '--color-primary-100': '#ddeee0',
    '--color-primary-200': '#bedcc5',
    '--color-primary-300': '#92c3a1',
    '--color-primary-400': '#68a67d',
    '--color-primary-500': '#43865c',
    '--color-primary-600': '#306b48',
    '--color-primary-700': '#27553a',
    '--color-primary-800': '#214430',
    '--color-primary-900': '#1c3829',
    '--color-primary-950': '#0f1f16',
  ...
  dark: vars({
    '--color-primary-0': '#0f1f16',
    '--color-primary-50': '#1c3829',
    '--color-primary-100': '#214430',
    '--color-primary-200': '#27553a',
    '--color-primary-300': '#306b48',
    '--color-primary-400': '#43865c',
    '--color-primary-500': '#68a67d',
    '--color-primary-600': '#92c3a1',
    '--color-primary-700': '#bedcc5',
    '--color-primary-800': '#ddeee0',
    '--color-primary-900': '#f1f8f3',
